    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          <h4 style= {{textAlign: 'left'}}>Users</h4>
        </Typography>
      )}
      ...
      <div className = 'text-end' style={{ padding: "10px 20px", textAlign: "center", color: "white" }} onChange={handleFilter}><input type ="text"></input></div>
    </Toolbar>
  );
}
